                    ...
                    onClick={async () => {
                      ...
                      try {
                        await updateDoc(doc(db, "users", user.uid), {
                          credits: (userData?.credits || 0) + 1200,
                        });
                ...
                <div className="bg-slate-300/10 border border-slate-300/50 rounded-2xl p-5 relative overflow-hidden">
                  ...
                  <button
                    onClick={async () => {
                      ...
                      try {
                        await updateDoc(doc(db, "users", user.uid), {
                          credits: (userData?.credits || 0) + 3500,
                        });
                        alert(
                          "Pagamento Simulado! 3500 Créditos adicionados na sua conta.",
                        );
                        setShowCreditsModal(false);
                      } catch (e: any) {
                        alert(e.message);
                ...
                <div className="bg-yellow-400/10 border border-yellow-400/50 rounded-2xl p-5 relative overflow-hidden">
                  ...
                  <button
                    onClick={async () => {
                      ...
                      try {
                        await updateDoc(doc(db, "users", user.uid), {
                          credits: (userData?.credits || 0) + 5000,
                          plan: "ouro",
                        });
                        alert(
                          "Pagamento Simulado! Você agora é Ouro e ganhou 5000 Créditos.",
                        );
                        setShowCreditsModal(false);
                      } catch (e: any) {
                        alert(e.message);
